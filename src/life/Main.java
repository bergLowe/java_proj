...
interface Generation {
    ...
    private static int countNeighbors(char[][] grid, int size, int row, int col) {
        int countNeighbor = 0;
        // isCol - keeps track either row/column is to be changed for traversing neighbor.
        // isInc - keeps tracks when to increment or decrement the row/col to traverse neighbor.
        boolean isCol = true,
                isInc = true;
        int[] index;
        for (int k = 0; k < 8; k++) {
